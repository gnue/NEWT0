...
/*------------------------------------------------------------------------*/
/** オブジェクトの深いクローン複製をする（マジックポインタは追跡しない） (OBSOLETE)
 *
 * @param r			[in] オブジェクト
 *
 * @return			クローン複製されたオブジェクト
...
/*------------------------------------------------------------------------*/
/** オブジェクト内のアクセスパスの有無を調べる (OBSOLETE)
 *
 * @param r			[in] オブジェクト
 * @param p			[in] アクセスパス
 *
...
/*------------------------------------------------------------------------*/
/** オブジェクトのアクセスパスに値をセットする (OBSOLETE)
 *
 * @param r			[in] オブジェクト
 * @param p			[in] アクセスパス
 * @param v			[in] 値オブジェクト
...
/*------------------------------------------------------------------------*/
/** オブジェクトの指定された位置に値をセットする (OBSOLETE)
 *
 * @param r			[in] オブジェクト
 * @param p			[in] 位置
 * @param v			[in] 値オブジェクト
...
/*------------------------------------------------------------------------*/
/** プロト・ペアレント継承でフレーム内のスロットの有無を調べる (OBSOLETE)
 *
 * @param r			[in] フレーム
...
/*------------------------------------------------------------------------*/
/** sub が supr のサブクラスを含むかチェックする (OBSOLETE)
 *
...
/*------------------------------------------------------------------------*/
/** sub が supr のサブクラスかチェックする (OBSOLETE)
 *
 * @param sub		[in] シンボルオブジェクト１
 * @param supr		[in] シンボルオブジェクト２
 *
...
/*------------------------------------------------------------------------*/
/** obj が r のインスタンスかチェックする (OBSOLETE)
 *
 * @param obj		[in] オブジェクト
 * @param r			[in] クラスシンボル
 *
...
/*------------------------------------------------------------------------*/
/** 文字列オブジェクトの最後にオブジェクトを文字列化して追加する (OBSOLETE)
 *
